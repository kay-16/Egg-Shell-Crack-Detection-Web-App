...
import logger
import visualize_lms
import filtering
import filename_utils   

arduino = serial.Serial(port='/dev/cu.usbmodemFX2348N1', baudrate=115200, timeout=.1) # /dev/cu.usbmodemFX2348N1
...
try:
    ...
    stream = p.open(format=FORMAT,
                    ...
                    input_device_index=0)  # Use connected microphone
